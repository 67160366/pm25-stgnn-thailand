...
1. **ห้ามแตะอะไรทั้งสิ้นก่อนส่งรายงาน 17 ก.ค. 17:00 (SIMS)** — งานทุกข้อในไฟล์นี้เริ่มหลังส่งเท่านั้น
2. ทุกฟีเจอร์ต้องไม่ทำลาย honest thesis: ห้าม claim ความแม่นเพิ่มโดยไม่มีหลักฐาน ต้องคง caveat เดิมทั้งหมด
3. ข้อ 1–4 **ไม่ต้องเทรนใหม่** (inference/engineering ล้วน) — ทำก่อน; ข้อ 5 เป็น experiment ผลไม่การันตี — ทำคู่ขนาน
