# [TODO: NSC Disclaimer - Thai + English, booklet page 44]
...
def build() -> None:
    ...
    add_content_slide(
        ...
        [
            (
                "ERA5 มี latency → ระบบจริงต้องใช้ NWP forecast; วัดผลแล้ว: edge 48h ทนต่อ noise ถึง 0.5× ความผันผวนธรรมชาติ",
                0,
                False,
            ),
            (
