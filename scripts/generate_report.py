...
body(
    ...
    "(+4.4% / +9.1%) และแพ้ขอบฟ้าสั้น — ยืนยันว่าผลไม่ได้เกิดจากการรั่วไหลของข้อมูล",
)
...
for i, t in enumerate(
    [
        ...
        "หลักฐานความทนต่อ noise ของ NWP (§6.4) โหมดนี้ปิดจุดอ่อน “hindcast” โดยไม่กล่าวเกินจริง",
        ...
        "เดียวกับ §6.5 ทำให้ “คันโยกนโยบาย” จับต้องได้",
...
body(
    doc,
    "**การอ่านผลอย่างตรงไปตรงมา:** โมเดล **เอาชนะ persistence เฉพาะที่ขอบฟ้า 48 ชั่วโมง** (ทั้งสองเกณฑ์ "
    "ด้วยระยะห่างเล็กน้อย) ซึ่งสอดคล้องกับผล RMSE (§6.1) ที่โมเดลเด่นเฉพาะขอบฟ้ายาว ส่วนขอบฟ้าสั้น "
...
body(
    doc,
    "เพื่อตัดข้อครหาเรื่องการรั่วไหลของข้อมูล (leakage) ทุกทาง คณะผู้พัฒนานำ **โมเดลรายงานที่แช่แข็งไว้** "
...
body(
    ...
    "ชั่วโมง (+4.4% และ +9.1%) และแพ้ที่ขอบฟ้าสั้น — รูปแบบเดียวกับผล held-out 2568 ทุกประการ ซึ่งเป็น"
...
body(
    ...
    "บน **2 checkpoint** (demo และ report/split2) สำหรับเหตุการณ์เรือธง 18 มี.ค. 2568 — แหล่ง "
...
body(
    ...
    "**ขนาดของสัดส่วนขึ้นกับ checkpoint**: มีเพียง **แม่สอด** ที่สัดส่วนต่างชาติของเหตุการณ์เรือธงสูง"
    "ภายใต้ **ทั้งสอง checkpoint** (0.957 และ 0.994) ขณะที่แม่สายและแม่ฮ่องสอน “พลิก” จาก 0 (demo) เป็น"
    "สูง (report) — เราแสดงทั้งสอง checkpoint โดยไม่เลือกเฉพาะอันที่สวย ตามหลักการรายงานผลตามจริง",
)
body(
    doc,
    "**(ข) ความไม่แน่นอนของ attribution จากหลาย seed** — เพื่อเปลี่ยน caveat “ขนาดขึ้นกับโมเดล” จาก"
    "คำเตือนลอย ๆ เป็นตัวเลขที่วัดจริง คณะผู้พัฒนารัน attribution ซ้ำด้วยโมเดล full variant **3 seed** "
    "ที่แม่ฮ่องสอน — แหล่ง `transboundary_uncertainty.json`: เหตุการณ์เรือธง 18 มี.ค. 2568 ให้สัดส่วน"
    ...
    "0.0–1.0 (เฉลี่ย 54.2%) ควบคู่เสมอ ข้อสรุปเชิงคุณภาพ (ระบบไล่ตามไฟข้ามแดนที่สถานีชายแดน) มั่นคงกว่า"
    "ตัวเลขขนาดเชิงปริมาณ ซึ่งเรารายงานพร้อมความไม่แน่นอนนี้อย่างเปิดเผย",
)
